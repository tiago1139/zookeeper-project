...
{
  static const MessageT__DataT init_value = MESSAGE_T__DATA_T__INIT;
  *message = init_value;
}
...
static const ProtobufCFieldDescriptor message_t__data_t__field_descriptors[2] =
{
  {
    "datasize",
    1,
    ...
    0,   /* quantifier_offset */
    offsetof(MessageT__DataT, datasize),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned message_t__data_t__field_indices_by_name[] = {
  1,   /* field[1] = data */
  0,   /* field[0] = datasize */
};
static const ProtobufCIntRange message_t__data_t__number_ranges[1 + 1] =
{
  { 1, 0 },
  { 0, 2 }
};
const ProtobufCMessageDescriptor message_t__data_t__descriptor =
{
  PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC,
  "message_t.data_t",
  "DataT",
  "MessageT__DataT",
  "",
  sizeof(MessageT__DataT),
  2,
  message_t__data_t__field_descriptors,
  message_t__data_t__field_indices_by_name,
  1,  message_t__data_t__number_ranges,
  (ProtobufCMessageInit) message_t__data_t__init,
  NULL,NULL,NULL    /* reserved[123] */
};
...
static const ProtobufCFieldDescriptor message_t__field_descriptors[7] =
{
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_INT32,
    0,   /* quantifier_offset */
    offsetof(MessageT, operation_value),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
